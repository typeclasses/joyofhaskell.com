...
The takeaway is that when we use the word "type" it can mean any of several things: "type declaration" on its own, "type plus instances", names of "types" or "type constructors", a property of an algebraic structure (footnote what algebraic structure is?). These are not in conflict; they are all essential, in our view, to understanding what types and typeclasses are.
...
<blockquote>Typeclass instances can be very boilerplatey but usually in a satisfyingly shove-it-under-the-rug-and-don't-worry-about-it-again sort of way</blockquote>
...
<blockquote>and it's really "a monad in X is a monoid in the category of endofunctors of X" not just the category of endofunctors.</blockquote>
